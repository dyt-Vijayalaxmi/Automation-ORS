...
public class AddProducts extends Weblibrary{
									...
									String HsCode, String PrdPrice,String selectorder) 
	{
		...
		bStatus = uploadFile(edit_prdImage,  "C:\\Users\\Chaitanya\\Desktop\\Project details\\Sample images\\images9.jpg");
		Reporter.log(bStatus, "file is selected", "file is not selected");
		
		wait(3);
		
		bStatus = uploadFile(edit_prdSDS,  "E:\\pdf\\sel_Manul_Pdf.pdf");
		Reporter.log(bStatus, "file is selected", "file is not selected");
		wait(3);
		
		bStatus = uploadFile(edit_prdPSS,  "E:\\pdf\\Manual.pdf");
		Reporter.log(bStatus, "file is selected", "file is not selected");
		wait(3);
